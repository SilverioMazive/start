<?php
  ...
  include "proc/doutoramentoadd.php";
...
if(isset($_GET['delete'])){  
  $mestradoid = (int)str_replace(' ', '', intval($_GET['delete']));
  $estado = "desativado";
  
  $sqlme = "UPDATE tbmestrados SET estado='".$estado."' 
  where mestradoid=".$mestradoid." AND instid=".$instid;
...
<head>
  ...
  <title>Adicionar Doutoramento</title>
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data" action="doutoramentoadd.php">
              ...
              <div class="form-group">
                ...
                placeholder="Área científica (Ex: Direito, Informatica...)">
              </div>
             
              <div class="form-group">
                <label for="exampleFormControlTextarea1">Regime do curso</label>
                <select name="regimeid" id="category">
                  <?php
                    $estado = 'desativado';
                    $sql = "SELECT * FROM tbregime";
              ...
              <div class="form-group">
                ...
                <select name="provinciaid" id="category">
                  <?php
                    $estado = 'desativado';
              ...
              <hr>
              <div class="form-group">
                <label for="exampleFormControlTextarea1">Descricao do Curso de Doutoramento</label>
                <textarea name="descricao"></textarea>
              </div>
              <hr>
              <div class="form-group">
                <label for="exampleFormControlTextarea1">Saídas profissionais</label>
                <textarea name="saidasprofissionais"></textarea>
              </div>

              <input type="submit" name="submit" class="btn btn-success" value="Adicionar Doutoramento">
            </form>
          </div>
        </div>
