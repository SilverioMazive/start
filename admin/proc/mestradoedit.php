...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT * FROM tbmestrados WHERE instid=".$_SESSION['instid']." AND mestradoid=".$id;
...
if(isset($_POST['submit'])) {
    ...
    $mestradoid = $_SESSION['mestradoid'];
      
    $query = "UPDATE tbmestrados 
        SET
        instid = '$instid', 
        nome ='$nome',
        duracao = '$duracao',
