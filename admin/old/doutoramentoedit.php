<?php
  ...
  include "proc/doutoramentoedit.php";

  if(isset($_GET['id']))
  {
    $doutid = $_GET['id'];
    $_SESSION['doutid'] = $doutid;    
  }
  else
  {
    header("location: doutoramentoall.php");
  }
...
<head>
  ...
  <title>Editar Doutoramento</title>
    ...
    <div class="row">
      <div class="col-lg-6">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data" action="desafiocriar.php">
              <div class="form-group">
                <label for="exampleInputEmail1">Nome</label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="nome" aria-describedby="emailHelp"
                  placeholder="Nome do curso de Doutoramento" value="<?php echo $row['nome'] ?>">                
              </div>
              <div class="form-group">
