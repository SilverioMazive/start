<?php
    ...
    if(isset($_POST['tlcliente']) && isset($_POST['tlcliente']))
    {
      $telefone = htmlentities(mysqli_real_escape_string($conn , $_POST['tlcliente']));
      $password = htmlentities(mysqli_real_escape_string($conn , $_POST['password']));
      
      // Proses login user
      if($user->login($telefone, $password))
      {
        setcookie('telefonecliente',$telefone, (time() + (365 * 24 * 3600)));
...
<head>
    ...
    <title>Login - Dream Seeder</title>
                ...
                <form method="POST" action="">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="checkout__input">
                                <!-- <input type="submit" name="submit" class="site-btn" value="Login"> -->
                            ...
                            <h6><span class=""></span> Não tem uma conta? <a href="login-user.html">Registre-se</a>
                            </h6>
