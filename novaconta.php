...
{
     if(isset($_POST['tlcliente']) && isset($_POST['nome']) && isset($_POST['reppassword']) && isset($_POST['password']) && isset($_POST['bairroid']))
    {
      $nome = htmlentities(mysqli_real_escape_string($conn , $_POST['nome']));
      $categoria = 'cliente';
      $telefone = (int)str_replace(' ', '', intval($_POST['tlcliente']));
      $password = htmlentities(mysqli_real_escape_string($conn , $_POST['password']));
      $reppassword = htmlentities(mysqli_real_escape_string($conn , $_POST['reppassword']));
...
<head>
    ...
    <title>Registro - Dream Seeder</title>
...
<body>
    ...
    <section class="checkout spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h6><span class=""></span> Já tem uma conta? <a href="login-user.php">LOGIN</a>
                    </h6>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                                ...
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        ...
                                        <select name="bairroid" class="form-control" id="category">
                                          <option value="0">-- Selecione a sua localizacao --</option>
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="text" placeholder="Rua, Número da Casa, Ponto de referencia (*)">
                            </div>
                            ...
                            <input type="submit" name="submit" class="site-btn" value="Registrar">
