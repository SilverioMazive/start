<?php  
	...
	if(isset($_GET['tlcliente']))
    {
		...
		if (mysqli_num_rows($resultno1) > 0) 
		{
	    	...
	    	$sqlJ = "SELECT tbvendas.valor AS valorrecebido, tbvendas.data AS datavenda, tbvendas.telefone AS telefonecliente, tbvendas.nomecliente AS nomecliente
					FROM tbvendas where tbvendas.vendedorid='$uid'";
			...
			{
			    //SEM DADOS
				$arr = array('vendalist' => 1, 'resposta' => 'Nenhuma informação encontrada!');
